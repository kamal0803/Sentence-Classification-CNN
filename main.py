...
def main():
    ...
    train_model(model_random, train_new_sentences, Y_train, test_new_sentences, Y_test, vocab, epochs=10)

    print("================RUNNING MODEL 2 - STATIC (static word2vec)==================================")
    train_model(model_static, train_new_sentences, Y_train, test_new_sentences, Y_test, vocab, epochs=10)

    print("================RUNNING MODEL 3 - NON STATIC (fine tuned word2vec)==================================")
    train_model(model_non_static, train_new_sentences, Y_train, test_new_sentences, Y_test, vocab, epochs=10)

    print("================RUNNING MODEL 4 - MULTI CHANNEL==================================")
    train_model(model_multi_channel, train_new_sentences, Y_train, test_new_sentences, Y_test, vocab, epochs=10)
